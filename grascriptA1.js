...
class GraMemory {
    constructor(cards, username) {
        ...
        this.sessionTime = 5 * 60; // 15 minutes in seconds
    ...
    sendVictoryData() {
        ...
        console.log('Victory data being sent:', data); 
    ...
    sendBugReportData(bugReportText) {
        ...
        console.log('Bug report data being sent:', data);
    ...
    showBugReportModal() {
        ...
        document.getElementById('submit-bug-report').addEventListener('click', () => {
            ...
            console.log('Submit button clicked. Bug report text:', bugReportText); 
    
            if (bugReportText.trim()) {
                this.sendBugReportData(bugReportText); 
